"use strict";!function(){const e={colors:null,buttonsTarget:'#customization article[data-theme="generated"]',selectorButton:"#customization button[data-color]",selectorSection:"#customization",buttons:null,generatedStyles:null,init(){this.generateButtons(),this.setActiveButton("pink"),this.generateTheme("pink")},generateButtons(){let e="",a="";for(const r in this.colors)e+=`<button data-color="${r}" aria-label="Activate ${r} theme"></button>`,a+=`
        button[data-color="${r}"] {
          background-color: ${this.colors[r][600]};
        }
        [data-theme="light"] button[data-color="${r}"]:hover,
        [data-theme="light"] button[data-color="${r}"]:active,
        [data-theme="light"] button[data-color="${r}"]:focus {
          background-color: ${this.colors[r][700]}; '
        }
        [data-theme="dark"] button[data-color="${r}"]:hover,
        [data-theme="dark"] button[data-color="${r}"]:active,
        [data-theme="dark"] button[data-color="${r}"]:focus {
          background-color: ${this.colors[r][500]};
